namespace FieldValidatorAPI
{
    public static class CommonRegularExpressionValidationPatterns
    {
        ...
        public const string US_PhoneNumber_RegEx_Pattern = @"^(?:\([2-9]\d{2}\)\ ?|[2-9]\d{2}(?:\-?|\ ?))[2-9]\d{2}[- ]?\d{4}$";
        ...
        public const string US_Post_Code_RegEx_Pattern = @"^(\d{5}-\d{4}|\d{5})$|^([a-zA-Z]\d[a-zA-Z] \d[a-zA-Z]\d)$";
